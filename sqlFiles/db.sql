...
CREATE TYPE valid_payment_type AS ENUM ('debit', 'credit', 'cash', 'cheque', 'paypal');
	
CREATE TYPE valid_payment_status AS ENUM ('approved', 'pending', 'completed', 'declined', 'incomplete');
